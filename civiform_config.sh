...
export CIVIC_ENTITY_SHORT_NAME="Danielle"

# REQUIRED
# The full name for the civic entity. Ex. "City of Rochester"
export CIVIC_ENTITY_FULL_NAME="City of Danielle"

# REQUIRED
# The email address to contact for support with using Civiform. Ex. "Civiform@CityOfRochester.gov
export CIVIC_ENTITY_SUPPORT_EMAIL_ADDRESS="daniellekatz@google.com"
...
export SENDER_EMAIL_ADDRESS="daniellekatz@google.com"
...
export STAGING_PROGRAM_ADMIN_NOTIFICATION_MAILING_LIST="daniellekatz@google.com"

# REQUIRED
# The email address that receives a notifications email each time an applicant
# submits an application to a program in the staging environments, instead of
# sending it to the trusted intermediary's email, as would happen in prod.
export STAGING_TI_NOTIFICATION_MAILING_LIST="daniellekatz@google.com"

# REQUIRED
# The email address that receives a notifications email each time an applicant
# submits an application to a program in the staging environments, instead of
# sending it to the applicant's email, as would happen in prod.
export STAGING_APPLICANT_NOTIFICATION_MAILING_LIST="daniellekatz@google.com"

# REQUIRED
# The domain name for this CiviForm deployment, including the protocol. 
# E.g. "https://civiform.seattle.gov"
export BASE_URL="https://daniellekatz-dev2.civiform.dev"
...
export STAGING_HOSTNAME="daniellekatz-dev2.civiform.dev"
...
export AWS_USERNAME="daniellekatz+aws2@google.com"
...
export APP_PREFIX="dkatz-dev2" # max 19 chars, only numbers, letters, dashes, and underscores
...
export SSL_CERTIFICATE_ARN="arn:aws:acm:us-east-2:939721407065:certificate/0742602f-e09d-463c-8a92-4831742012f2"
